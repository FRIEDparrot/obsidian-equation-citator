const en = {
    ...
    "settings.websiteNotesExportIgnoredFilePatterns.name": "Ignored website note file patterns",
    "settings.websiteNotesExportIgnoredFilePatterns.desc": "Markdown filename patterns skipped when exporting website notes. Patterns are matched against markdown filenames and saved with a .md ending.",
    "settings.websiteNotesExportIgnoredFilePatterns.invalidNotice": "Ignored file pattern must be a filename pattern, not a folder path.",
    "settings.websiteNotesExportIgnoredFilePatterns.duplicateNotice": "This ignored file pattern already exists.",
    ...
    "settings.equationManagePanelFilterTagOnlyEquation.name": "Filter tag only equation",
    ...
    "settings.equationManagePanelFilterBoxedEquation.name": "Filter boxed equation",
    "settings.equationManagePanelFilterBoxedEquation.desc": "Default value for filter boxed equations",
    "settings.skipFirstlineInBoxedFilter.name": "Skip first line when filter boxed equation",
